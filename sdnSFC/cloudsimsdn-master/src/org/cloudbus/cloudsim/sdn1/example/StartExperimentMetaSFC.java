...
import org.cloudbus.cloudsim.sdn.policies.vmallocation.VmAllocationPolicySHCVNFP;
import org.cloudbus.cloudsim.sdn.policies.vmallocation.VmAllocationPolicySAVNFP;
import org.cloudbus.cloudsim.sdn.policies.vmallocation.VmAllocationPolicyMemVNFP;
 ...
 */
public class StartExperimentMetaSFC {
	protected static String physicalTopologyFile 	= "sfc-example-physical.json";//"dataset-energy/energy-physical.json";
	protected static String deploymentFile 		= "sfc-example-virtual.json";//"dataset-energy/energy-virtual.json";
	protected static String [] workload_files 			= { 
		"sfc-example-scale-workload.csv"
	...
	private static void printUsage() {
		...
		System.out.format("Usage: %s <SHC|SA> <0|1> <physical.json> <virtual.json> <working_dir> [workload1.csv] [workload2.csv] [...]\n", runCmd);
	}
			...
			case SHCBW:
				vmAllocationFac = new VmAllocationPolicyFactory() {
					public VmAllocationPolicy create(List<? extends Host> list,
						...
						return new VmAllocationPolicySHCVNFP(list); 
					}
				};
				/*vmAllocationFac = new VmAllocationPolicyFactory() {
					public VmAllocationPolicy create(List<? extends Host> list,
			...
			case SAFlow:
				vmAllocationFac = new VmAllocationPolicyFactory() {
					public VmAllocationPolicy create(List<? extends Host> list,
						...
						return new VmAllocationPolicySAVNFP(list); 
					}
				};
				/*vmAllocationFac = new VmAllocationPolicyFactory() {
					public VmAllocationPolicy create(List<? extends Host> list,
...
//			snos.setMonitorEnable(false);
			...
			if(!StartExperimentMetaSFC.logEnabled) 
				Log.disable();
