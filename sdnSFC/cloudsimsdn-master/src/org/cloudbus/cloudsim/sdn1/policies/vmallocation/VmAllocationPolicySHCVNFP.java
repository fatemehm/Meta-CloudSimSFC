 ...
 */
public class VmAllocationPolicySHCVNFP extends VmAllocationPolicy implements PowerUtilizationMaxHostInterface {
	 ...
	 * @post $none
	 */
	public VmAllocationPolicySHCVNFP(List<? extends Host> list) {
		super(list);
	...
	public boolean allocateHostForVm(Vm vm) {
		...
		for(int i = 0; result == false && i < numHosts; i++) {// we still trying until we find a host or until we try all of them
			double lessFree = Double.NEGATIVE_INFINITY;
			int idx = -1;
